    ...
    <form action="da.php" method="post">
        <div class="content">
            <div class="container">
                ...
                <div class="form-group">
                    <input class="form-sbm" type="submit" value="Đăng Kí"name='signup'></div>
                    <a href="da.php" class="already" align="center">You already have an account? Login here.</a>
            </div>
        </div>
 </form>

<?php
$connect=mysqli_connect("localhost","root","","dangkydetai");
if(!$connect){
